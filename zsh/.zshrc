...
__conda_setup="$('/home/lukaselmlund/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
...
[ -f "/home/lukaselmlund/.ghcup/env" ] && source "/home/lukaselmlund/.ghcup/env" # ghcup-env